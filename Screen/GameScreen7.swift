...
struct GameScreen7: View {
    ...
    var body: some View {
        ...
        GeometryReader {
            ...
            checkMarkDirt1 = CGPoint(x: CalculateX(xPos: 0.6), y: CalculateY(yPos: 0.5))
            checkMarkDirt2 = CGPoint(x: CalculateX(xPos: 0.44), y: CalculateY(yPos: 0.55))
            checkMarkDirt3 = CGPoint(x: CalculateX(xPos: 0.39), y: CalculateY(yPos: 0.66))
            checkMarkDirt4 = CGPoint(x: CalculateX(xPos: 0.58), y: CalculateY(yPos: 0.657))
        }
    }

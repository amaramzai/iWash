...
struct GameScreen6: View {
    ...
    var body: some View {
        ...
        GeometryReader {
            ...
            checkMarkDirt1 = CGPoint(x: CalculateX(xPos: 0.44), y: CalculateY(yPos: 0.365))
            checkMarkDirt2 = CGPoint(x: CalculateX(xPos: 0.6), y: CalculateY(yPos: 0.43))
            checkMarkDirt3 = CGPoint(x: CalculateX(xPos: 0.362), y: CalculateY(yPos: 0.44))
            checkMarkDirt4 = CGPoint(x: CalculateX(xPos: 0.5), y: CalculateY(yPos: 0.6))
        }
    }
